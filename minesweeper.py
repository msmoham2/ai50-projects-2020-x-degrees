...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        if cell in neighbours:
            ...
            #only include certain neighbours
            ...
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    if sentence1 == sentence2:
                        ...
                        continue
                    elif len(sentence2.cells) == 0:
                        continue
                    elif sentence1.cells.issubset(sentence2.cells):
                        sentence = Sentence(sentence2.cells - sentence1.cells, sentence2.count - sentence2.count)
                        if sentence not in self.knoledge:
                                self.knowledge.append(sentence)

                    elif sentence2.cells.issubset(sentence1.cells):
                        sentence = Sentence(sentence1.cells - sentence2.cells, sentence1.count - sentence1.count)
